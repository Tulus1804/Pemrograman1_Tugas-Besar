        ...
        <div class="blog-item">
          ...
          <div class="row">
            ...
            <div class="col-xs-12 col-sm-10 blog-content">
              <a href="index.php?page=detail_berita&id=<?php echo $data['id_post'] ?>"><img
                  class="img-responsive img-blog" src="images/berita/<?php echo $data['header'] ?>" width="100%"
                  alt="<?php echo $data['header'] ?>" /></a>
              <h2><a
                  href="index.php?page=detail_berita&id=<?php echo $data['id_post'] ?>"><?php echo $data['judul'] ?></a>
              </h2>
              <h3><?php echo substr($data['isi_post'], 0, 100) ?>"..."</h3>
              <a class="btn btn-primary readmore"
                href="index.php?page=detail_berita&id=<?php echo $data['id_post'] ?>">Read More <i
