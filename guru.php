    ...
    <div class="skill-wrap clearfix">
      <div class="center wow fadeInDown">
        ...
        <form class="col-md-4" role="form" method="POST">
          <input type="text" name="cari" class="form-control search_box" autocomplete="off"
      ...
      <div class="row clearfix">
        ...
        <div class="col-md-4 col-sm-6">
          <div class="single-profile-top wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
            <div class="media">
              <div class="pull-left">
                <a href="#"><img class="media-object" src="images/guru/<?php echo $data['foto'] ?>"
                    alt="<?php echo $data['foto'] ?>"></a>
              </div>
