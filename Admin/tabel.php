          ...
          <table class="table table-bordered data-table">
            ...
            <tbody>
              ...
              <tr class="gradeX">
                ...
                <td>
                  <a class="btn btn-mini btn-primary" href="index.php?page=ubahuser&id=<?php echo $data['id_user'] ?>">Ubah</a> &nbsp;
                  <a class="btn btn-mini btn-danger" href="crud/user/delete.php?id=<?php echo $data['id_user'] ?>" onclick="return confirm('Apakah anda yakin ?')">Hapus</a>
                </td>
              </tr>
              <?php $i++; } ?>
            </tbody>
          ...
          <table class="table table-bordered data-table">
            ...
            <tbody>
              ...
              <tr class="gradeX">
                ...
                <td>
                  <a class="btn btn-mini btn-primary" href="index.php?page=ubahmenu&id=<?php echo $data['id_menu'] ?>">Ubah</a> &nbsp;
                  <a class="btn btn-mini btn-danger" href="crud/menu/delete.php?id=<?php echo $data['id_menu'] ?>" onclick="return confirm('Apakah anda yakin ?')">Hapus</a>
                </td>
              </tr>
              <?php $i++; } ?>
            </tbody>
          ...
          <table class="table table-bordered data-table">
            ...
            <tbody>
              ...
              <tr class="gradeX">
                ...
                <td>
                  <a class="btn btn-mini btn-primary" href="index.php?page=ubahdetailmenu&id=<?php echo $data['id_md'] ?>">Ubah</a> &nbsp;
                  <a class="btn btn-mini btn-danger" href="crud/detailmenu/delete.php?id=<?php echo $data['id_md'] ?>" onclick="return confirm('Apakah anda yakin ?')">Hapus</a>
                </td>
              </tr>
              <?php $i++; } ?>
            </tbody>
          ...
          <table class="table table-bordered data-table">
            ...
            <tbody>
              ...
              <tr class="gradeX">
                ...
                <td>
                  <a class="btn btn-mini btn-primary" href="index.php?page=ubahguru&id=<?php echo $data['nik'] ?>">Ubah</a> &nbsp;
                  <a class="btn btn-mini btn-danger" href="crud/guru/delete.php?id=<?php echo $data['nik'] ?>" onclick="return confirm('Apakah anda yakin ?')">Hapus</a>
                </td>
              </tr>
              <?php $i++; } ?>
            </tbody>
          ...
          <table class="table table-bordered data-table">
            ...
            <tbody>
              ...
              <tr class="gradeX">
                ...
                <td>
                  <a class="btn btn-mini btn-primary" href="index.php?page=ubahsiswa&id=<?php echo $data['nis'] ?>">Ubah</a> &nbsp;
                  <a class="btn btn-mini btn-danger" href="crud/siswa/delete.php?id=<?php echo $data['nis'] ?>" onclick="return confirm('Apakah anda yakin ?')">Hapus</a>
                </td>
              </tr>
              <?php $i++; } ?>
            </tbody>
...
<?php if($_GET['page'] == "katberita"){ ?>

<div class="container-fluid">
  <div class="row-fluid">
    <div class="span12">
      <span><a class="btn btn-mini btn-success" href="index.php?page=tambahkatberita">Tambah</a></span>
      <div class="widget-box">
        <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
          ...
          <table class="table table-bordered data-table">
            ...
            <tbody>
              ...
              <tr class="gradeX">
                ...
                <td>
                  <a class="btn btn-mini btn-primary" href="index.php?page=ubahkatberita&id=<?php echo $data['id_kat'] ?>">Ubah</a> &nbsp;
                  <a class="btn btn-mini btn-danger" href="crud/kategoriberita/delete.php?id=<?php echo $data['id_kat'] ?>" onclick="return confirm('Apakah anda yakin ?')">Hapus</a>
                </td>
              </tr>
              <?php $i++; } ?>
            </tbody>
          ...
          <table class="table table-bordered data-table">
            ...
            <tbody>
              ...
              <tr class="gradeX">
                ...
                <td><?php echo $data['nama_user'] ?></td>
                <td>
                  <a class="btn btn-mini btn-primary" href="index.php?page=ubahberita&id=<?php echo $data['id_post'] ?>">Ubah</a> &nbsp;
                  <a class="btn btn-mini btn-danger" href="crud/berita/delete.php?id=<?php echo $data['id_post'] ?>" onclick="return confirm('Apakah anda yakin ?')">Hapus</a>
                </td>
              </tr>
              <?php $i++; } ?>
            </tbody>
