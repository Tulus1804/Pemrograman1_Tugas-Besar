<div class="container-fluid">
  <div class="quick-actions_homepage">
    <ul class="quick-actions">
      ...
      <li class="bg_lr span3"> <a href="index.php?page=menu"> <i class="icon-signal"><span class="label label-important"><?php echo $rowmenu ?></span></i>Menu</a> </li>
      ...
      <li class="bg_lg span3"> <a href="index.php?page=kategoripost"> <i class="icon-user"></i><span class="label label-important"><?php echo $rowkatber ?></span>Kategori Berita</a></li>
      <li class="bg_lg span3"> <a href="index.php?page=berita"> <i class="icon-user"></i><span class="label label-important"><?php echo $rowberita ?></span>Berita</a></li>
