        ...
        <div class="widget-content nopadding">
          <form action="crud/user/update.php" method="POST" class="form-horizontal">
            <div class="control-group">
              <label class="control-label">ID. USER :</label>
              <div class="controls">
                <input type="text" readonly class="span11" value="<?php echo $data['id_user'] ?>" name="iduser"
            ...
            <div class="control-group">
              <label class="control-label">Nama User :</label>
              <div class="controls">
                <input type="text" class="span11" value="<?php echo $data['nama_user'] ?>" name="namauser"
...
<div class="container-fluid">
  ...
  <div class="row-fluid">
    <div class="span10">
      <div class="widget-box">
        <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
          <h5>From Ubah Detail Menu</h5>
        </div>
        <div class="widget-content nopadding">
          <form action="crud/detailmenu/update.php" method="POST" class="form-horizontal">
            <div class="control-group">
              <input type="hidden" name="id_md" value="<?php echo $id ?>">
              <label class="control-label">Nama Menu :</label>
              <div class="controls">
                <select name="menu" required>
            ...
            <div class="control-group">
              <label class="control-label">Slug Menu :</label>
              <div class="controls">
                <input type="text" name="slug" value="<?php echo $data['slug_menu'] ?>" class="span11" placeholder="Slug Menu" required />
              </div>
            </div>
            <div class="form-actions">
              <input type="submit" class="btn btn-success" value="Simpan">
        ...
        <div class="widget-content nopadding">
          <form action="crud/guru/update.php" method="POST" enctype="multipart/form-data" class="form-horizontal">
            ...
            <div class="control-group">
              <label class="control-label">Tempat Lahir :</label>
              <div class="controls">
                <input type="text" name="tmp_lahir" class="span11" value="<?php echo $data['tmp_lahir'] ?>" placeholder="Tempat Lahir" required />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Tanggal Lahir :</label>
              <div class="controls">
                <input type="date" name="tgl_lahir" class="span11" value="<?php echo $data['tgl_lahir'] ?>" placeholder="Tanggal Lahir" required />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Status :</label>
            ...
            <div class="control-group">
              <label class="control-label">Mengajar :</label>
              <div class="controls">
                <input type="text" name="mengajar" class="span11" value="<?php echo $data['mengajar'] ?>" placeholder="Mengajar" required />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Alamat :</label>
              <div class="controls">
                <input type="text" name="alamat" class="span11" value="<?php echo $data['alamat'] ?>" placeholder="Alamat" required />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">No. Hp :</label>
              <div class="controls">
                <input type="text" name="no_hp" class="span11" value="<?php echo $data['no_hp'] ?>" placeholder="No. Hp" required />
              </div>
            </div>
            <div class="form-actions">
              <input type="submit" class="btn btn-success" value="Simpan">
        ...
        <div class="widget-content nopadding">
          <form action="crud/siswa/create.php" method="POST" enctype="multipart/form-data" class="form-horizontal">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" name="thn_masuk" placeholder="Tahun Masuk" required />
              </div>
            </div>
            <div class="form-actions">
              <input type="submit" class="btn btn-success" value="Simpan">
        ...
        <div class="widget-content nopadding">
          <form action="crud/siswa/update.php" method="POST" enctype="multipart/form-data" class="form-horizontal">
            <div class="control-group">
              <label class="control-label">NIS :</label>
              <div class="controls">
                <input type="text" readonly class="span11" name="nis" value="<?php echo $data['nis'] ?>" placeholder="NIS" required />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Foto :</label>
            ...
            <div class="control-group">
              <label class="control-label">Nama Siswa :</label>
              <div class="controls">
                <input type="text" class="span11" name="nama" value="<?php echo $data['nama_siswa'] ?>" placeholder="Nama Siswa" required />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Jenis Kelamin :</label>
            ...
            <div class="control-group">
              <label class="control-label">Tempat Lahir :</label>
              <div class="controls">
                <input type="text" class="span11" name="tmp_lahir" value="<?php echo $data['tmp_lahir'] ?>" placeholder="Tempat Lahir" required />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Tanggal Lahir :</label>
            ...
            <div class="control-group">
              <label class="control-label">Tahun Masuk :</label>
              <div class="controls">
                <input type="text" class="span11" name="thn_masuk" value="<?php echo $data['tahun_masuk'] ?>" placeholder="Tahun Masuk" required />
              </div>
            </div>
            <div class="form-actions">
              <input type="submit" class="btn btn-success" value="Simpan">
...
<?php if($_GET['page'] == "tambahkatberita"){ ?>
...
<div class="container-fluid">
  ...
  <div class="row-fluid">
    <div class="span6">
      <div class="widget-box">
        <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
          <h5>From Tambah Kategori Berita</h5>
        </div>
        <div class="widget-content nopadding">
...
<?php if($_GET['page'] == "ubahkatberita"){ 
  $id = $_GET['id'];
...
<div class="container-fluid">
  ...
  <div class="row-fluid">
    <div class="span6">
      <div class="widget-box">
        <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
          <h5>From Ubah Kategori Berita</h5>
        </div>
        <div class="widget-content nopadding">
          <form action="crud/kategoriberita/update.php" method="POST" class="form-horizontal">
            <div class="control-group">
              ...
              <div class="controls">
                ...
                <input type="text" name="kategori" class="span11" value="<?php echo $data['kategori_post'] ?>" placeholder="Nama Kategori" required />
              </div>
            </div>
            <div class="form-actions">
              <input type="submit" class="btn btn-success" value="Simpan">
        ...
        <div class="widget-content nopadding">
          <form action="crud/berita/create.php" method="POST" enctype="multipart/form-data" class="form-horizontal">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" name="tanggal" class="span10" required readonly placeholder="Tanggal"
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="file" name="foto" class="span10" required placeholder="Header" />
              </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" name="id_admin" class="span10" required readonly placeholder="Tanggal"
